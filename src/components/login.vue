		...
		<div class="sub-main-w3">
			...
			<form action="#" method="post">
				<div class="pom-agile">
					...
					<input placeholder="E-mail" name="email" class="user" type="email" v-model="email" required="">
				</div>
				<div class="pom-agile">
					<span class="fa fa-key" aria-hidden="true"></span>
					<input placeholder="Password" name="password" class="pass" type="password" v-model="password" required="">
				</div>
				<div class="sub-w3l">
					<div class="sub-agile">
